...
# - Some generic linear algebra helpers (`zeros_like`, `to_cpu`,
#   `columnwise_norms`, `columnwise_dots`, `compute_λ`) are used in this
#   implementation. They are defined in utilities.jl, with GPU-optimized
#   variants dispatching on `AbstractGPUArray`.
...
function lobpcg(A, X, B=I, precon=I, tol=1e-10, maxiter=100;
    ...
    while true
        ...
        #       rest of the algorithm, we should change this in the future.
